...
function App() {
  ...
  const fetchItems = () => {
    fetch("https://todolist-c4b20-default-rtdb.firebaseio.com/items/.json")
  ...
  const deleteTodo = (id) => {
    ...
    fetch(`https://todolist-c4b20-default-rtdb.firebaseio.com/items/${id}.json`, 
    {
  ...
  return (
    <div className="App">
      ...
      <div
        ...
        style={{ height: 400, width: 690, margin: "auto" }}
      >
